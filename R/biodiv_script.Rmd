...
run_biodiv_analysis <- function(df_subset) {
      ...
      iNEXT(inc_freq, q = 0, datatype = "incidence_freq", nboot = 1, endpoint = 125) # Benthic is 125 and pelagic is 250
}
...
sb_se <- results_list$Benthic$AsyEst$Est_s.e.[1] #78.12

# For Pelagic species
sp_obs <- results_list$Pelagic$AsyEst$Observed[1] # 137
sb_se <- results_list$Pelagic$AsyEst$Est_s.e.[1] #218
