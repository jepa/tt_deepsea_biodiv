...
main_map <- ggplot() +
      ...
      scale_color_viridis_c(
            ...
            # This is needed to expand the bar for bigger numbers (comment out for A, B6, C8)
            guide = guide_colorbar(
    barheight = unit(8, "cm")  # <- Increase only the color bar
    # barwidth  = unit(0.4, "cm") # <- Optional: narrow bar if needed
  )
      ) +
      # Remove space from plot to axis
      scale_x_continuous(expand = c(0, 0)) +
      ...
      theme(
            ...
            legend.text = element_text(size = 12) #A8 B10 C12
      ) +
      labs(
            x = "Longitude",
            y = "Latitude"
...
ggsave(
      "./map_figure/jaime_map_revised_c.png",
      main_map,
      width = 10,
      height = 6
)
